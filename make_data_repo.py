...
repo_name = 'v11_BETA_2022-01-22'
repo_dir = build_common.get_repo_dir() + repo_name
pklsource = 'currentData_pickles'

descriptive_notes = f""" This is an OpenFF data repository.
Created {datetime.date.today()}
Bulk download from FracFocus on:  Jan. 22, 2022
CodeOcean version: 11- BETA, minor changes. calcMass set to NaN when 0, and
related issues - mostly when data are not consistent. Two new carrier algorithms to
catch "problem" disclosures.
"""
