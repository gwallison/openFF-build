...
def add_CompTox_refs(df,sources='./sources/'):
    ...
    #reffn = 'CCD-Batch-Search_2022-09-30_10_17_19.csv'
...
#        ctdf['DTXSID'] = ctdf.DTXSID.str[-13:]
    ...
    refdf = pd.read_csv(sources+reffn,quotechar='$',encoding='utf-8')
    # we currently use CASRN for bgCAS because of duplicate sysnonyms
